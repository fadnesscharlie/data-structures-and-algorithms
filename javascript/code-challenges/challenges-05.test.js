...
const addValues = (arr) => {
  // Solution code here...
  let totals = arr.reduce((arr, num)=> arr + num, 0);
  return totals;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let totals = arr.reduce((acc, num) => {
    acc += num.purchasePrice;
    return acc;
  }, 0);
  return totals;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let totals = arr.reduce((acc, num, index) => {
    return index + 1;
  });
  return totals;
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let names = arr.reduce((acc, value, index) => {
    acc.push(value.children[index]);
    return acc;
  }, []);
  return names;
};
